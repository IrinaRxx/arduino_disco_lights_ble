...
class EffectDiscoStrobeLights : public EffectIface
{
  enum { BRIGHTNESS               = 255 };
  enum { FRAMES_PER_SECOND        = 100 };
  enum { ZOOMING_BEATS_PER_MINUTE = 122 }; 
...
public:
  ...
  void Init()
  {
    ...
    NEOPIXEL_STRIP_EFFECT_SET_PERIOD_MS(this, 1000/FRAMES_PER_SECOND);
    ...
    zoomBPM = ZOOMING_BEATS_PER_MINUTE;
  }
...
protected:
  ...
  void discostrobe()
  {
    ...
    fill_solid( NEOPIXEL_STRIP_EFFECT_LEDS(this), NEOPIXEL_STRIP_EFFECT_LENGTH(this), CRGB::Black);
  ...
  void discoWorker( 
      ...
      uint8_t huedelta)
   {
    ...
    drawRainbowDashes( sStartPosition, NEOPIXEL_STRIP_EFFECT_LENGTH(this)-1, 
